...
//		System.out.printf("onsetsds_whiten: relaxcoef=%g, relaxtime=%g, floor=%g\n", relaxcoef, ods.relaxtime, floor);
	...
	public boolean init() {
		...
		// Arguments
		sample_rate = Double.valueOf(arguments.get("sample_rate", "44100.0"));
		frame_size = Integer.valueOf(arguments.get("frame_size", "512"));
		String 	onset_output_str = arguments.get("onset_output", "sample"); // boolean (a bool valeu for each frame), time, sample
