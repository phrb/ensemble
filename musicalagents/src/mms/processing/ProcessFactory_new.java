...
public class ProcessFactory_new {
	...
	public static Process createAudioProcessor(String library, String operation, Parameters arguments) {
...
//		}
		...
		final Process fftproc = ProcessFactory_new.createAudioProcessor(AudioOperation.FFT, parameters);
		final Process fftproc2 = ProcessFactory_new.createAudioProcessor(AudioOperation.FFT, parameters);
