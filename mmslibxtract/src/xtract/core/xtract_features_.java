...
public final class xtract_features_ {
  ...
  public final static xtract_features_ XTRACT_SPECTRAL_AVERAGE_DEVIATION = new xtract_features_("XTRACT_SPECTRAL_AVERAGE_DEVIATION");
