...
public class ES_AudioEventServer extends EventServer 
{
	ES_World world;
	...
	{
		System.err.println ( "Audio_Event_Server: Configured." );
		setEventType ( "SOUND" );
		return true;
	}
	...
	public boolean init ( ) 
	{
		System.err.println ( "Audio_Event_Server: Initialized." );
	...
	{
		System.err.println ( "ES_AudioEventServer Says: " + agentName + " registered: " + actuatorName );
		return userParam;
	}
}
