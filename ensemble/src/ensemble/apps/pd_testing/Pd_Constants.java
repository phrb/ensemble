...
public final class Pd_Constants 
{
	...
	public static final String AGENT_CLASS = "ensemble.apps.pd_testing.Pd_Agent";
	public static final String ACTUATOR_CLASS = "ensemble.apps.pd_testing.Pd_Actuator";
	public static final String SENSOR_CLASS = "ensemble.apps.pd_testing.Pd_Sensor";
	public static final String REASONING_CLASS = "ensemble.apps.pd_testing.Pd_Reasoning";
